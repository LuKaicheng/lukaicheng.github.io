...
其中
- name 表示规则名称，对于它的解释可以参考[Rule Naming](https://github.com/LuKaicheng/lukaicheng.github.io/blob/hexo/source/_posts/ABNF.md#12-规则名称)，
- elements 可以是一个或者多个规则或者最终值的操作组合，关于最终值可以参考[Terminal Values](https://github.com/LuKaicheng/lukaicheng.github.io/blob/hexo/source/_posts/ABNF.md#13-最终值)
- crlf 行结束标志(回车换行)
...
由于级联和选择混用时，往往会让人困惑，建议使用序列组合来消除歧义。
